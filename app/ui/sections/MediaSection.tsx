    ...
    <SectionWrapper id="media-buying-and-user-acquisition" className="bg-white">
      ...
      <Container>
        <div className="flex flex-col laptop:flex-row pt-28 laptop:pt-0 items-center laptop:justify-between">
          <div className="text-primary max-w-[500px] pb-8 laptop:pb-0">
            <p className="text-lg pb-7">
              In the realm of online media buying and user acquisition, finding
              a company that aligns with your brand&apos;s objectives and adapts
              to your unique needs is crucial. It entails a blend of knowledge,
              expertise, and established relationships to ensure your ads are
              effectively placed in front of the right audience, at the right
              moment.
            </p>
            <p className="text-lg">
              Leveraging data-driven programmatic media buying technologies, we
              craft customized growth strategies tailored to your specific
              targets.
            </p>
          </div>
          <div>
        ...
        <div className="flex laptop:justify-between items-center flex-col laptop:flex-row-reverse pt-28">
          ...
          <div className="order-2 laptop:order-1 laptop:mr-40 text-primary max-w-[500px] px-8">
            <p className="text-lg pt-9 laptop:pt-0">
              Ready to elevate your online presence and drive targeted user
              acquisition? Let&apos;s craft tailored strategies to amplify your
              brand&apos;s reach and ROI. Reach out to us now and unlock the
              power of strategic media buying!
            </p>
            <div className="pt-8">
              <Button
                label="Contact us"
