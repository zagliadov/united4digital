    ...
    <SectionWrapper className="bg-white" id="publishers">
      ...
      <Container>
        <div className="flex laptop:justify-between items-center flex-col laptop:flex-row-reverse">
          ...
          <div className="text-primary max-w-[500px] pt-28 laptop:pt-0 order-1 laptop:order-2 pb-8 laptop:pb-0">
            <h3 className="text-3xl font-bold">
              What is the process of ad monetization?
            </h3>
            <p className="text-lg pt-8">
              Ad monetization generally operates by displaying various types of
              advertisements on a website, application CTV/OTT or audio channel
              and receiving commission or fee, whenever the ad garners views or
              clicks.
            </p>
          </div>
        </div>
        ...
        <div className="flex laptop:justify-between flex-col items-center laptop:flex-row-reverse pt-28">
          <div className="order-2 laptop:order-2">
            <IntegrationProcessGraph />
          </div>

          <div className="text-primary max-w-[500px] order-1 laptop:order-1 pb-8 laptop:pb-0">
            <h3 className="text-3xl font-bold">Integration Process Overview</h3>
        ...
        <div className="flex laptop:justify-between items-center flex-col laptop:flex-row-reverse pt-28">
          ...
          <div className="text-primary max-w-[500px] order-1 laptop:order-2 pb-8 laptop:pb-0">
            <h3 className="text-3xl font-bold pb-8">
              Comprehensive AD SUPPORT
            </h3>
            <p className="text-lg pb-7">
              We facilitate all ad formats and accessible channels, encompassing
              display, native, audio, video, and connected TVs. Through our
              bidding technology, we aggregate demand across various media types
              and devices, fostering a highly competitive, real-time auction for
              each unique ad impression.
            </p>
            <p className="text-lg font-bold pt-4">
              Elevate your revenue while ensuring a captivating user experience
            </p>
          </div>
        </div>
        ...
        <div className="flex laptop:justify-between items-center flex-col laptop:flex-row-reverse pt-28">
          ...
          <div className="order-2 laptop:order-1 text-primary max-w-[500px] px-8">
            <p className="text-lg pt-9 laptop:pt-0">
              ...
              space? Let&apos;s maximize your revenue potential together. Reach
              out to us now!
            </p>
            <div className="pt-8">
              <Button
